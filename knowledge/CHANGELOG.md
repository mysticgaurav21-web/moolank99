...
- Initial permanent knowledge-base directory.
- ID-016 Impulse Control Canonical v1.2 for Moolank 1.
- ID-016 evidence and boundary review.
- Master knowledge index.
- Project status and research-recovery notes.
- Canonical trait JSON schema.

### Decisions

- ID-016 is classified as a conditional shadow trait.
